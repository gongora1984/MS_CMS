...
namespace CMSSERVICE.INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20230227180936_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("AppPermissionId");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CreatedOnUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "RegisterLawPractice"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOnUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "RegisterLocalCounsel"
                        },
                        new
                        {
                            Id = 4,
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRoleLoginDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("AppRoleLoginDetailId");
                    ...
                    b.HasKey("Id")
                        .HasName("PKAppRoleLoginDetail");

                    b.HasIndex(new[] { "AppRoleId" }, "FKAppRoleAppRoleLoginDetail");

                    b.HasIndex(new[] { "LoginDetailId" }, "FKLoginDetailAppRoleLoginDetail");

                    b.HasIndex(new[] { "AppRoleId", "LoginDetailId" }, "UXAppRoleLoginDetail")
                        .IsUnique();

                    b.ToTable("AppRoleLoginDetail", (string)null);
                });

            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("AppRolePermissionId");
                    ...
                    b.HasKey("Id")
                        .HasName("PKAppRolePermission");

                    b.HasIndex(new[] { "AppPermissionId" }, "FKAppPermissionAppRolePermission");

                    b.HasIndex(new[] { "AppRoleId" }, "FKAppRoleAppRolePermission");

                    b.HasIndex(new[] { "AppPermissionId", "AppRoleId" }, "UXAppPermisionRole")
                        .IsUnique();
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRoleLoginDetail", b =>
                {
                    b.HasOne("CMSSERVICE.DOMAIN.Entities.AppRole", "AppRole")
                        .WithMany("AppRoleLoginDetails")
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRolePermission", b =>
                {
                    b.HasOne("CMSSERVICE.DOMAIN.Entities.AppPermission", "AppPermission")
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.AppRole", b =>
                {
                    b.Navigation("AppRoleLoginDetails");
            ...
            modelBuilder.Entity("CMSSERVICE.DOMAIN.Entities.Client", b =>
                {
                    ...
                    b.Navigation("ClientDepartments");
